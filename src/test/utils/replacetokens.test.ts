...
test('String identifier without whitespace, expect replacement', () => {
	...
	const state = { componentid: { display: 'displayvalue', value: undefined, valid: undefined } };
...
test('numeric identifier, numeric in store, expect replacement', () => {
	...
	const state = { 1: { display: 'displayvalue', value: undefined, valid: undefined } };
...
test('string identifier, with repeat index', () => {
	...
	const state = {
		'componentid.1': { display: 'displayvalue', value: undefined, valid: undefined }
	};
...
test('numeric identifier, string in store, with repeat index', () => {
	...
	const state = { 1.1: { display: 'displayvalue', value: undefined, valid: undefined } };
